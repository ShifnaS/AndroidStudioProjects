...
public class SendPaymentActivity extends EclairActivity
  ...
  private void sendLNPayment(final long amountMsat, final PaymentRequest pr, final String prAsString) {
   ...
   // Toast.makeText(app, "hash "+paymentHash, Toast.LENGTH_SHORT).show();
   // Toast.makeText(app, "channelID "+p.getLocalChannelId(), Toast.LENGTH_SHORT).show();
   // Toast.makeText(app, "Id "+p.getId(), Toast.LENGTH_SHORT).show();


    if (p != null && p.getStatus() == PaymentStatus.PAID) {
      msg="This payment has already been paid";
      canNotHandlePayment(R.string.payment_error_paid);
    } else if (p != null && p.getStatus() == PaymentStatus.PENDING) {
      msg="This payment is already processing";
      ...
      AsyncExecutor.create().execute(
        ...
        //    Toast.makeText(app, "desc "+paymentDescription, Toast.LENGTH_SHORT).show();
           // Log.e("Channel id","/////////////////////////////////////////////// "+p.getId());
           // Log.e("Local Channel id","/////////////////////////////////////////////// "+p.getLocalChannelId());
  ...
  private void closeAndGoHome() {
    Toast.makeText(app, "Message "+msg, Toast.LENGTH_SHORT).show();
    if(goToFrag.equals(""))
    {
